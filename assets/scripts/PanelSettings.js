...
NORD.PanelSettings = function(config) {
  ...
  this.buttonSave.on('button_click', function(data) {
  ...
  this.buttonPrev.on('button_click', function(data) {
  ...
  this.buttonNext.on('button_click', function(data) {
    var n = this.pages.indexOf(this.page) + 1;
...
NORD.PanelSettings.prototype.createPanelAi = function() {
  ...
  var startY = 0;
  var padding = 40;
  var labelTitleCore = createLabel(this.panelAi, -240, -30, 'AI:', this.labelH2Style);
  ...
  this.createParametr({
    ...
    sliderShiftX: 60,
    y: 0 + padding * 4,
    label: 'Action mul bonus:',
    parametr: this.field.config.aiActionMul,
    min: 1.0,
    max: 2.0
...
NORD.PanelSettings.prototype.createPanelCore = function() {
  ...
  var startY = 0;
  var padding = 40;
  var labelTitleCore = createLabel(this.panelCore, -240, -30, 'General:', this.labelH2Style);
  labelTitleCore.anchor = {
    x: 0,
    y: 0.5
  };
  ...
  this.labelActionMode = createLabel(this.panelCore, 0, 0 + padding * 6 + 40, this.actionMode, this.labelH2Style);
  this.pages.push({
    name: 'core',
    container: this.panelCore
  });
...
NORD.PanelSettings.prototype.createPanelPaddle = function() {
  ...
  this.paddleView.on('change', function(data) {
  ...
  }, this); // this.paddleViewSmall = new PaddleView2();
  ...
  var labelTitle = createLabel(this.panelPaddle, -240, -30, 'Paddle:', this.labelH2Style);
  labelTitle.anchor = {
    x: 0,
    y: 0.5
  };
...
NORD.PanelSettings.prototype.createPanelBall = function() {
  ...
  this.ballView.y = 300;
  var labelTitle = createLabel(this.panelBall, -240, -30, 'Ball:', this.labelH2Style);
  labelTitle.anchor = {
    x: 0,
    y: 0.5
  };
...
NORD.PanelSettings.prototype.createPanelBonuses1 = function() {
  ...
  var labelTitle = createLabel(this.panelBonuses1, -240, -30, 'Big Ball Little Paddles:', this.labelH2Style);
  labelTitle.anchor = {
    x: 0,
    y: 0.5
  ...
  var labelTitle2 = createLabel(this.panelBonuses1, -240, startY + padding * 3 + 30, 'Bumper:', this.labelH2Style);
  labelTitle2.anchor = {
    x: 0,
    y: 0.5
  };
...
NORD.PanelSettings.prototype.createPanelBonuses2 = function() {
  ...
  var labelTitle = createLabel(this.panelBonuses2, -240, -30, 'Stun Gun:', this.labelH2Style);
  labelTitle.anchor = {
    x: 0,
    y: 0.5
  };
  ...
  this.createParametr({
    ...
    min: 5,
    max: 20
  }); // const labelTitle2 = createLabel(this.panelBonuses2, -240, startY + padding * 4 + 30, 'Bonus Additional Ball:', this.labelH2Style);
  // labelTitle2.anchor = { x:0, y: 0.5 };
  //
  // startY = startY + padding * 4 + 30 + 30;
  //
  // this.createParametr({ type: 'slider', container: this.panelBonuses2, x: startX, sliderShiftX: 60, y: startY, label: 'Container duration:', parametr: this.field.config.bonusNewBallContainerDuration, min: 0, max: 30 });
...
NORD.PanelSettings.prototype.createPanelBonuses3 = function() {
  ...
  var labelTitle = createLabel(this.panelBonuses3, -240, -30, 'Kitty:', this.labelH2Style);
  labelTitle.anchor = {
    x: 0,
    y: 0.5
  };
  ...
  var labelTitle2 = createLabel(this.panelBonuses3, -240, startY + padding * 1 + 30, 'Gravity Well:', this.labelH2Style);
  labelTitle2.anchor = {
    x: 0,
    y: 0.5
  };
...
NORD.PanelSettings.prototype.createPanelBoards1 = function() {
  ...
  var labelTitle = createLabel(this.panelBoards1, -240, -30, 'Multiball:', this.labelH2Style);
  labelTitle.anchor = {
    x: 0,
    y: 0.5
  };
  ...
  var labelTitle3 = createLabel(this.panelBoards1, -240, startY + padding * 2 + 30, 'Fire Zone:', this.labelH2Style);
  labelTitle3.anchor = {
    x: 0,
    y: 0.5
  };
...
NORD.PanelSettings.prototype.createPanelBonuses4 = function() {
  ...
  var labelTitle = createLabel(this.panelBonuses4, -240, -30, 'Invisible Area:', this.labelH2Style);
  labelTitle.anchor = {
    x: 0,
    y: 0.5
  };
  var startX = -240;
  var startY = 0;
  var padding = 40; // this.createParametr({ type: 'slider', container: this.panelBonuses4, x: startX, sliderShiftX: 60, y: startY, label: 'Duration:', parametr: this.field.config.bonusInvisibleAreaDuration, min: 0, max: 30 });
  ...
  this.createParametr({
    ...
    y: startY + padding * 0,
    label: 'Width:',
    parametr: this.field.config.bonusInvisibleAreaWidth,
    min: 50,
    max: 400
  });
  var labelTitle2 = createLabel(this.panelBonuses4, -240, startY + padding * 1 + 30, 'Invisible Wall:', this.labelH2Style);
  labelTitle2.anchor = {
    x: 0,
    y: 0.5
  };
...
NORD.PanelSettings.prototype.createParametr = function(data) {
  ...
  if (type === 'slider') {
    var label = createLabel(container, data.x, data.y, data.label, this.labelStyle);
    label.anchor = {
      x: 0,
      y: 0.5
    };
    ...
    slider.state.on('value_change', function(data) {
    ...
    stepper.y = data.y;
    stepper.state.on('value_change', function(data) {
      parametr.value = data.value;
    }, this);
    parametr.on('change', function() {
      updateParametr();
    }, this);

    function updateParametr() {
...
PaddleView.prototype.setSize = function(radiusP, height) {
  var platformSize = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;
  // if(radiusP > 1) radiusP = 1;
  this.radiusP = radiusP;
  this.radius = (0.5 + radiusP) * height;
  this.paddleHeight = height;
  this.shift = Math.sqrt(this.radius * this.radius - this.paddleHeight / 2 * (this.paddleHeight / 2));
