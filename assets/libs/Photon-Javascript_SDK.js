        ...
        */
        ...
        PhotonPeer.prototype._send = function (data, checkConnected) {
            ...
            if (this._isConnected && !this._isClosing) {
                ...
                if (!checkConnected) {
                    NORD.events.emit(NORD.EVENT_CODE.GAME_CONNECTION_ERROR);
        ...
        PhotonPeer.prototype._parseInternalResponse = function (code, response) {
            ...
            NORD.events.emit(NORD.EVENT_CODE.PING_RECIEVED, this.lastRtt );
...
(function (Photon) {
    ...
    (function (LoadBalancing) {
        ...
        var LoadBalancingClient = /** @class */ (function () {
            ...
            */
            function LoadBalancingClient(protocol, appId, appVersion, actorConfig) {
                this.appId = appId;
                ...
                this._myActor = this.actorFactoryInternal(actorConfig.name, -1, true);
            ...
            */
            ...
            LoadBalancingClient.prototype._onOperationResponseInternal2 = function (code, data) {
                if (data.errCode) {
                    ...
                    //if(code == LoadBalancing.Constants.OperationCode.JoinGame)
                    {
                        NORD.events.emit(NORD.EVENT_CODE.GAME_DOES_NOT_EXIT);
                    }
                }
